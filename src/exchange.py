...
def getRateApi(dc,tc,getRateTime):
    try:
        ...
        url = 'http://www.unionpayintl.com/cardholderServ/serviceCenter/rate/search'
        # post获取数据
        req_header = {'User-Agent':'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.122 Safari/537.36',
        "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8",
        'Accept':'*/*',
        "Accept-Encoding": "gzip, deflate",
        "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8",
        'Connection': 'keep-alive',
        'Referer': "http://www.unionpayintl.com/cardholderServ/serviceCenter/rate?language=cn" #注意如果依然不能抓取的话，这里可以设置抓取网站的host
        }
